class Item < ApplicationRecord
  ...
  validates :price, presence: true, format: { with: /\A[a-zA-Z0-9]+\z/, message:'は¥300〜9,999,999で入力して下さい'}, numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9999999 }
